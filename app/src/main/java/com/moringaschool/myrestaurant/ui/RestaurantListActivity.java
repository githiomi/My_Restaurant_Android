                ...
                public void onResponse(Call call, Response response) {
                    ...
                    RestaurantListActivity.this.runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            mRestaurantsListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                                @Override
                                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                                    Toast.makeText(RestaurantListActivity.this, restaurantNames[position], Toast.LENGTH_SHORT).show();
                                }
                            });
